                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="/createorder" class="btn btn-dark mt-2 mb-2">Create Order</a>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        <thead>
                                            <tr class="bg-cyan">
                                                ...
                                                <th><h6 class="text-light">Customer Id</h6></th>
                                                <th><h6 class="text-light">Customer Email</h6></th>
                                                <th><h6 class="text-light">Customer Number</h6></th>
                                                <th><h6 class="text-light">Customer Skype</h6></th>
