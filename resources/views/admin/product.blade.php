                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>100</td>
                                                <td>USD</td>
                                                <td><video src="" height="90" weight="90"></video></td>
                                                <td>Ecommerce</td>
                                                <td>10%</td>
                                                <td>https://bluewitcher.com/user</td>
                                                <td>https://bluewitcher.com/admin</td>
                                                <td>7 days</td>
                                                <td>20</td>
                                                <td>user Id:
                                                    password:
                                              ...
                                              <td>Verified</td>
                                                ...
                                                <td><a href="viewproduct" class="btn btn-success">View</a></td>
                                                <td><a href="editproduct" class="btn btn-primary">Edit</a></td>
